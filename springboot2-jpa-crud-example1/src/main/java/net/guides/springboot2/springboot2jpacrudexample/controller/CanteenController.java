...
public class CanteenController<place> {
	...
	public ResponseEntity<Canteen> updateCanteen(@PathVariable(value = "id") int id,
		...
		canteen.setStartDate(canteenDetails.getStartDate());
		canteen.setEndDate(canteenDetails.getEndDate());
	...
	/*
	 * @ModelAttribute("canteens") public List<Canteen> getCanteens{ List<Canteen>
	 * list=new ArrayList<Canteen>(); list.add(new Canteen("Nakshratha"));
	 * list.add(new Canteen("Amritha")); list.add(new Canteen("Lakshmi"));
	 * list.add(new Canteen("Akshaya")); list.add(new Canteen("Aarogya")); return
	 * list; }
	 */
}
